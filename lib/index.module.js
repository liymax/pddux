...
function createProvider(reducer, actions, context) {
  return function (_React$PureComponent) {
    ...
    function _class(props) {
      ...
      var dispatch = function dispatch(actionModel) {
        return new Promise(function (resolve) {
          var newState = produce(_this.state, function (draft) {
...
var map = function map(context) {
  var mapStore = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  return function (Component) {
    return function () {
      ...
      return React.createElement(
        ...
        null,
        function (store) {
          var props = mapStore.reduce(function (o, e) {
            o[e] = store[e];
            return o;
          }, {});
...
export { createProvider, map, multiMap };
